          ...
          <form className="login100-form" onSubmit={handleSubmit}>
            ...
            {page === "register" && (
              <div className="wrap-input100">
                <input
                  ...
                  disabled={loading}
                  onChange={(e) => {
                    setNamePlaceholder(e.target.value ? false : true);
                  }}
                  required
                />
                <span
            ...
            <div className="wrap-input100">
              <input
                ...
                disabled={loading}
                onChange={(e) => {
                  setEmailPlaceholder(e.target.value ? false : true);
                }}
                required
              />
              <span
                className={
                  emailPlaceholder ? "focus-input100" : "focus-input100 has-val"
                }
            ...
            <div className="wrap-input100">
              ...
              <input
                ...
                ref={passwordRef}
                onChange={(e) => {
                  setPasswordPlaceholder(e.target.value ? false : true);
                }}
                required
              />
              <span
            ...
            {page === "login" ? (
              <div className="text-center p-t-115">
                ...
                <span className="txt2" onClick={() => setPage("register")}>
                  Sign Up
                </span>
              </div>
            ) : (
              <div className="text-center p-t-115">
                ...
                <span className="txt2" onClick={() => setPage("login")}>
                  Login
                </span>
              </div>
            )}
